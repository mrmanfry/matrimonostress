...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Conferma la tua email per Wedsapp',
  invite: 'Sei stato invitato su Wedsapp',
  magiclink: 'Il tuo link di accesso a Wedsapp',
...
const SAMPLE_PROJECT_URL = "https://matrimonostress.lovable.app"
