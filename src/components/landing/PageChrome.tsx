              ...
              return (
                <Link
                  ...
                  style={{
                    fontSize: 17,
                    fontWeight: isActive ? 600 : 500,
                    color: isActive ? T.brandInk : T.ink,
                    padding: "14px 4px",
    ...
    <section style={{ position: "relative", overflow: "hidden" }}>
      ...
      <div
        style={{
          maxWidth: 980,
          margin: "0 auto",
          padding: isMobile ? "48px 20px 36px" : "88px 48px 56px",
          textAlign: "center",
          position: "relative",
        }}
      >
...
export const LandingFooter = () => {
  ...
  return (
    <footer style={{ background: "#1F1A16", color: "#E8E1D4", padding: isMobile ? "48px 0 28px" : "64px 0 32px" }}>
